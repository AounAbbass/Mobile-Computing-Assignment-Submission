    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="./photos/Yeah Brofist Short.jpg" alt="Pewds-T-Father-and-Son-Shirt" style="width:100%;">

        </div>

        <div class="item">
          <img src="./photos/Pewds Red and Black Jogger Pants" alt="Pew-Gamers-Shirt" style="width:100%;">

        </div>

        <div class="item">
          <img src="./photos/Pewds Leggings.jpg" alt="Pewds-70mill-club-Shirt" style="width:100%;">
      ...
      <div class="container">
        ...
        <div id="myCarousel2" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="./photos/MrBeast Raptor Leggings.jpg" alt="Mr-Beast-Tee" style="width:100%;">
            </div>

            <div class="item">
              <img src="./photos/Mr Beast Trousers.jpg" alt="Mr-Beast-Essentials-Tee" style="width:100%;">
            </div>

            <div class="item">
              <img src="./photos/Mr Beast Leggings.jpg" alt="Mr-Beast-Youth-Tee" style="width:100%;">
            </div>
